...
/*
 *	Class Rex\Util\Image
 *
 *  Was just a little class to do some cropping and resizing at first, but has ballooned to function
 *  as a kind of wrapper for many of the GD filters etc.
 *
 *  Public methods
 *  scale
 *  crop
...
class Image
{
  ...
  protected $quality = 100; 
    ...
    if(filesize($image) > pow(2,20)) throw new ImageException('File is over 2Mb and so is probably too big for Image class');
